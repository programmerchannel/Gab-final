  ...
  ?>
	...
	<?php if(isset($_GET['s'])){echo("<div id='success'  class='alert alert-success'>
    <strong>Success! your account is registered. Please login.</strong> 
  </div>");};?>
            ...
            <div class="layout-wrapper ">
                ...
                <div id="right" class="page page--trader page--login">
                    <div class="container login ">
                        ...
                        <div class="">
                            <h1 class="login__heading">        Sign in to your account
        ...
        <div id="sign-in" class="transition--zoom-in zoomed-in">
                <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="login.php"
                      method="post">
                    ...
                    <div class="login__row login__row--shy login__remember-me">
                            <div class="form-check">
                                ...
                                <span><a tabindex="5" id="forget" style="cursor:pointer">Forgot Password?</a></span>
                    </div>

                    <div class="login__submit login__row">
                        <input type="hidden" id="id-hidden-input" name="credentialId"
                               />
                        <button tabindex="4"
                                class="btn btn--fluid btn-primary btn-sm "
                                type="submit" name="login_user" value="Sign In">
                            Sign in
                        </button>
                    </div>
                </form>
            ...
            <div class="login__row" >
                <p >
                    ...
                    <a style="cursor:pointer" tabindex="6"
                       class="text--semi-bold" href="registerup.php">
                    Register
                    </a>
                </p>
            </div>
 ...
 document.getElementById("forget").addEventListener("click", function(){location.replace("email.php");
  ...
  <script>
  document.getElementById("success").addEventListener("click",function(){document.getElementById("success").style.visibility="hidden";})
