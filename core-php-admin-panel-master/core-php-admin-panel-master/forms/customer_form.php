<fieldset>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
        <label for="l_name">add</label>
        <input type="text" name="add" value=" " placeholder="Last Name" class="form-control"  id="l_name">
    </div> 

 <div class="form-group">
        <label for="l_name">deduct</label>
        <input type="text" name="deduct" value=" " placeholder="Last Name" class="form-control"  id="l_name">
    </div> 	
    ...
    <div class="form-group text-center">
        <label></label>
        <button name="save" type="submit" class="btn btn-warning" >Save <span class="glyphicon glyphicon-send"></span></button>
    </div>            
</fieldset>
