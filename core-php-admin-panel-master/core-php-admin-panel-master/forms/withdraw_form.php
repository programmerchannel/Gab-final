...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="balance" value="<?php echo $customer['to_name']; ?>" placeholder="Last Name" class="form-control" required="required" id="l_name">
    </div> 
	
	   <div class="form-group">
        <label for="l_name">Address*</label>
        <input type="text" name="balance" value="<?php echo $customer['to_address']; ?>" placeholder="Last Name" class="form-control" required="required" id="l_name">
    </div> 

   <div class="form-group">
        <label for="l_name">Country*</label>
        <input type="text" name="balance" value="<?php echo $customer['to_country']; ?>" placeholder="Last Name" class="form-control" required="required" id="l_name">
    </div> 
    ...
    <div class="form-group text-center">
        <label></label>
        <button type="submit" class="btn btn-warning" name = "withdapprove"  > Approve <span class="glyphicon glyphicon-send"></span></button>
		   <button type="submit" class="btn btn-warning" name="withddecline" > Decline <span class="glyphicon glyphicon-send"></span></button>
    </div>            
</fieldset>
