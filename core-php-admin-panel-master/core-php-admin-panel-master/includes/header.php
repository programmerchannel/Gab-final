                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li>
								 ...
								 <li>
                                    <a id="settings" href="setting.php" style="cursor:pointer"><i class="fa fa-users fa-fw"></i> Settings </a>
                                </li>
								 <li>
                                    <a id="smtp" href="smtpform.php" style="cursor:pointer"><i class="fa fa-users fa-fw"></i> Smtp </a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.sidebar-collapse -->
